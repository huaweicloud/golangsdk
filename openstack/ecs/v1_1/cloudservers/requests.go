...
func Create(client *golangsdk.ServiceClient, opts CreateOptsBuilder) (jobId, orderId string, err error) {
	var r CreateResult
	...
	_, err = client.Post(createURL(client), reqBody, &r.Body, &golangsdk.RequestOpts{OkCodes: []int{200}})
	if err != nil {
		return
	}
...
// Get job result.
func GetJobResult(client *golangsdk.ServiceClient, id string) (JobResult, error) {
	var r JobExecResult
