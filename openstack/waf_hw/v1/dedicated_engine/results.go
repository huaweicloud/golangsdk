...
// DedicatedEngine the dedicated waf instance detail.
type DedicatedEngine struct {
	Id                 string            `json:"id"`
...
// DedicatedEngineList the struct of returned by querying list.
type DedicatedEngineList struct {
	Total     int               `json:"total"`
	Purchased bool              `json:"purchased"`
	Items     []DedicatedEngine `json:"items"`
}
