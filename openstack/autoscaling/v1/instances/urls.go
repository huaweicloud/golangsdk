...
//of group
func listURL(client *gophercloud.ServiceClientExtension, groupID string) string {
...
//instances
func batchURL(client *gophercloud.ServiceClientExtension, groupID string) string {
